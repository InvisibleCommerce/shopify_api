...
class Fulfillment202107Test < Test::Unit::TestCase
  ...
  def test_15()
    stub_request(:get, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000833/fulfillments.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:get, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillment_orders/1046000833/fulfillments.json")
  end
  ...
  def test_21()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019902/update_tracking.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019902/update_tracking.json")
  end
  ...
  def test_25()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019903/cancel.json")
      .with(
        headers: {"X-Shopify-Access-Token"=>"this_is_a_test_token", "Accept"=>"application/json", "Content-Type"=>"application/json"},
        body: {}
      )
    ...
    assert_requested(:post, "https://test-shop.myshopify.io/admin/api/2021-07/fulfillments/1069019903/cancel.json")
  end
  def test_7()
    stub_request(:post, "https://test-shop.myshopify.io/admin/api/2021-07/orders/450789469/fulfillments.json")
      .with(
